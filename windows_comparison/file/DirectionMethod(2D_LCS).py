...
#				print(f"Found similar objects: {similar_objects}")	#超奇怪，有這行的話會出現UnicodeEncodeError: 'cp950' codec can't encode character '\u2663' in position 136: illegal multibyte sequence
